            ...
            <nav class="nav">
                <div> 
                    ...
                    <div class="nav_list"> 
                        ...
                        <a href="http://localhost/DealerTech/admin/vendas.php" style="color: white;" class="nav_link active"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_name">Vendas</span> </a>
