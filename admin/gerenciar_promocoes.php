            ...
            <nav class="nav">
                ...
                <a href="http://localhost/DealerTech/index.php" class="nav_logo" style="color: white;text-decoration:none;"> <i class='fas fa-home'style="color:red;"></i> <span class="nav_logo-name">Home</span> </a>
                    <div class="nav_list"> 
                        ...
                        <a href="http://localhost/DealerTech/admin/gerenciar_promocoes.php" style="color: white;text-decoration:none;" class="nav_link active"> <i class='fas fa-money-bill'style="color:red;"></i> <span class="nav_name">Promoções</span> </a>
