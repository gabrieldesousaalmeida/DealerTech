    ...
    <div class="container">
        ...
        <div class="content second-content" style="display: flex;"> 
            ...
            <div class="second-culumn"> 
                ...
                <form class="form" name="dados" method="POST" action="http://localhost/DealerTech/admin/salva_mensagem.php"> 
                    <label for="" class="label-input icon-modify">
                        <i class="far fa-user icon-modify"></i>
                        <input type="text" name="nome" placeholder="Nome" style="box-shadow: 0 0 0 0;outline: 0;">
                    </label>
                    <label for="" class="label-input icon-modify">
                        <i class="far fa-envelope"></i>
                        <input type="email" name="email" placeholder=" Email" style="box-shadow: 0 0 0 0;outline: 0;">
                    </label>
                    <label for="" class="label-input icon-modify">
                        <i class="fas fa-lock"></i>
                        <input type="password" name="senha" placeholder=" Senha" style="box-shadow: 0 0 0 0;outline: 0;">
                    </label>
                    <label for=""class="label-input icon-modify">
