        ...
        <div class="limiter">
            <div class="container-login100">
                ...
                <?php
                    ...
                    while ($i <= $qtde_linhas) {
                    ?>
                    <div class="fila" style="margin-left:-400px; margin-top:40px;">
                        <div style="display: inline-block;">
                            <div class="wrap-input100 validate-input m-b-16" data-validate = "Digite o Modelo" style="width: 300px;margin-top:25px; margin-left:80px;">
                            <select class="input100" name="id_categoria<?php echo $i;?>" id="id_categoria<?php echo $i;?>" style="color: gray; outline: none; border: none;">
                        ...
                        <div style="display: inline-block;">
                            <div class="wrap-input100 validate-input m-b-16" style="width: 300px;margin-top:25px;margin-left:10px;" data-validate = "Digite o Modelo">
                        ...
                        <script type="text/javascript">
                            $(function(){
                                $('#id_categoria<?php echo $i;?>').change(function(){
                                    if( $(this).val() ) {
                                        $('#id_sub_categoria<?php echo $i;?>').hide();
                                        $('.carregando').show();
                                        $.getJSON('sub_categorias_post.php?search=',{id_categoria: $(this).val(), ajax: 'true'}, function(j){
                                            var options = '<option selected="selected" class="Country" style="display:none;">Modelo</option>';	
                                            for (var i = 0; i < j.length; i++) {
                                                options += '<option value="' + j[i].nome_sub_categoria + '">' + j[i].nome_sub_categoria + '</option>';
                                            }	
                                            $('#id_sub_categoria<?php echo $i;?>').html(options).show();
                                            $('.carregando').hide();
                                        });
                                    } else {
                                        $('#id_sub_categoria<?php echo $i;?>').html('<option selected="selected" class="Country" style="display:none;">Modelo</option>');
                                    }
                                });
                            });
                        </script>
