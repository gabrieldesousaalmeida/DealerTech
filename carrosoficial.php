			...
			<center>		
                ...
                ?>
                    <div class="car">
                        ...
                        <br> 
                        <?php echo "<img src='http://localhost/DealerTech/veiculos/".$rows_cursos['marca']."/".$rows_cursos['modelo']."/".$rows_cursos['modelo'].".png"."' style='height: 130px;'>";?> 
                        ...
                        <a href="" title="" style="font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;"> <br> <b> <i class="fas fa-eye"></i> Ver Carro </a>
                        </p>
                    </div class="car">	
				<?php
                    }
